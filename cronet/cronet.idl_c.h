...
CRONET_EXPORT
Cronet_RESULT Cronet_Engine_ClearClientCertificate(Cronet_EnginePtr self, Cronet_String hostPortPair);
CRONET_EXPORT
Cronet_RESULT Cronet_Engine_SetClientCertificate(Cronet_EnginePtr self, Cronet_String hostPortPair, Cronet_BufferPtr a, Cronet_BufferPtr b);
CRONET_EXPORT
